...
interface PropertyForm {
  ...
  features: string[]
  images: File[]
  existing_images: Array<{id: string, url: string, is_main: boolean}>
}
  ...
  useEffect(() => {
    const fetchPropertyData = async () => {
      try {
        ...
        // Fetch counties
        const countiesResponse = await api.get('/counties/')
        ...
        setFormData({
          ...
          lease_duration: property.lease_duration?.toString() || '12',
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="mb-4">
                ...
                <p className="text-sm text-gray-500 mt-2">
                  Upload up to 10 images total. First image will be the main image.
                </p>
              </div>
            </div>
